...
<form method="post" name="updateform" id="updateform">
    ...
    <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" class="komentar">
        ...
        <tr>
            ...
            <td width="71%" valign="top"><input name="tnama" type="text" id="tnama" size="50" maxlength="100" value="<?= $nama; ?>">
            </td>
        </tr>
        <tr>
            <td align="left" valign="top">Email</td>
            <td align="center" valign="top">:</td>
            <td valign="top"><input name="temail" type="text" id="temail" size="50" maxlength="50" value="<?= $email; ?>">
            </td>
        </tr>
        <tr>
